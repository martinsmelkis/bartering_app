...
-keep class app.bartering.bartering_app.IntegrityHelper {
    public <methods>;
}

-keep class app.bartering.bartering_app.MainActivity {
    public <methods>;
}

# Keep MethodChannel callbacks
-keepclassmembers class app.bartering.bartering_app.MainActivity {

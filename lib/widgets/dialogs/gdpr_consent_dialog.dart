...
class _GdprConsentDialogState extends State<GdprConsentDialog> {
  ...
  Future<void> _loadInitialConsentValues() async {
    final locationConsent =
        widget.initialLocationConsent ??
        await _settingsService.getStoredLocationConsent();
    final aiConsent =
        widget.initialAiProcessingConsent ??
        await _settingsService.getStoredAiProcessingConsent();
    final analyticsConsent =
        widget.initialAnalyticsCookiesConsent ??
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile.adaptive(
                  ...
                  onChanged: (value) =>
                      setState(() => _locationConsent = value),
            ...
            onPressed: () {
              Navigator.of(context).pop(
                GdprConsentChoice(
                  ...
                  analyticsCookiesConsent: kIsWeb
                      ? _analyticsCookiesConsent
                      : true,
                ),
              );
            },
